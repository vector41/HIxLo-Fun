...
export const MainTradingView: React.FC = () => {
    const {
        xScale,
        yScale,
        yScaleForAxis,
        ...
        <svg width={width} height={height}>
            ...
            >
                ...
                >
                    <div>
                        <div
                            className={`w-[5em] overflow-hidden text-center font-600 px-2 py-1 rounded-[0.9em]`}
                            style={{
                                background: `linear-gradient(60deg, ${winStatusColors[winStatus][0]}, ${winStatusColors[winStatus][1]})`,
                            }}
                        >
                            <div className="py-0.5 text-[0.5em] font-light">
                                LIVE BITCOIN
                            </div>
                            <div className="w-[4em] mx-auto bg-gradient-to-r from-[#fff0] via-[#fff] to[#fff0] h-[1px]"></div>
                            <div className="py-0.5 text-[0.8em] font-semibold">
            ...
            winStatus != WinStatus.TRADE_NOT_STARTED ? (
                ...
                >
                    <div>
                        <div
                            className={`w-[5em] overflow-hidden text-center font-600 px-2 py-1 rounded-l-[0.5em] rounded-r-[1em]`}
                            style={{
                                background: `linear-gradient(60deg, ${winStatusColors[0][0]}, ${winStatusColors[0][1]})`,
                            }}
                        >
                            <div className="py-0.5 text-[0.8em] font-medium">
            ...
            >
                ...
                >
                    <div className="w-[1em] h-[1em] mt-[-0.5em] rounded-full bg-[#EFF9FFAA] animate-ping"></div>
                </HtmlLabel>
            </Annotation>
        </svg>
    ) : (
